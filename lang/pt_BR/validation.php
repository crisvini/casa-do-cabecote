...
return [
    ...
    | pela classe de validação do Laravel. Algumas dessas regras possuem
    | múltiplas versões, como as regras de tamanho. Sinta-se à vontade
    | para ajustar cada uma conforme as necessidades da sua aplicação.
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Linhas personalizadas de validação
    |--------------------------------------------------------------------------
    |
    | Aqui você pode especificar mensagens personalizadas de validação para
    | atributos usando a convenção "attribute.rule". Isso facilita a
    | definição de mensagens específicas para regras de um campo.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas abaixo são usadas para substituir o placeholder de atributos
